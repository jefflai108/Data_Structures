...
public class publicTests {
	...
	public void testCast4() {
	    ...
	    KevinBaconNumber kv;
	        try {
	            kv = new KevinBaconNumber(filename, delimiter);
	            String s = kv.neighbors("Crazy (2006)");
	            String answer="[Agranov, David],[Barnett, Mandy],[Baxter, Beau],[Bergen, Danny],[Bibicoff, Allison],[Boller, David],[Boston, Rachel],[Briscoe, Brent],[Brown, Dwier],[Buckley, Brian (IV)],[Burke, Kristin M.],[Burton, Johnny 'Vegas'],[Calder, Michael],[Campbell, Scott Michael],[Cardinale, Alexander],[Cohen, Alan (I)],[Collins, Nick (III)],[Colvin, Shawn],[Conrad, David (I)],[Cordone, Chris],[Cross, Ryan (I)],[Curry, Christopher (I)],[Earl, Stacy],[Echeverría, Sandra],[El Razzac, Abdul Salaam],[Ellis, Chris (I)],[Emerick, Gerald],[Falkow, Mike],[Fleck, John (I)],[Forde, Evans],[Galasso, Jake],[Garrison, Lane],[Greenberg, Will],[Hawkins, Brad (I)],[Jones, Brian (XXIV)],[Klippert, Alissa],[Kollman, Jeff],[Larter, Ali],[LeAnn, Summer],[MacAlpine, Tony],[McLaughlin, Maya],[McPhee, Katharine],[Mitchell, Silas Weir],[O'Connor, Raymond],[O'Neill, Michael (I)],[Omundson, Timothy],[Palermo, Chris (I)],[Payne, Waylon],[Pease, David],[Poss, Jason],[Refuerzo, Ed],[Rendler-Kaplan, Lucy],[Rippenkroeger, Larry],[Rountree, Eden],[Rutledge, Stanton],[Ryan, James (V)],[Scherr, Jason],[Scherr, Lauren],[Small, Michael (VII)],[Smith, Jason Alan],[Sobel, Zach],[Statman, Paul],[Steinwedell, Nicole],[Tepe, Amanda],[Urquhart, Jeff],[Vai, Steve],[Wilkison, Aimee],[Workman, Scott],[Wright, Ryan (III)],";
	            assertEquals(s, answer);    
	        } catch (FileNotFoundException ex) {
	            System.err.println("Input File Not Found.");
	        } catch (IOException ex) {
